...
export function resolveVoice(parsed, { items=[], categories=[] } = {}) {
  ...
  if (itemMatch) return {
    ...
    matchLevel:'item', matchLabel: itemMatch.nombre, pendiente: false,
  }
  ...
  if (n3Match) return {
    ...
    matchLevel:'n3', matchLabel: n3Match.n3, pendiente: false,
  }
  ...
  if (n2Match) return {
    ...
    n4: 'Gasto general', cantidad, monto,
    matchLevel:'n2', matchLabel: n2Match.n2, pendiente: false,
  }
  ...
  if (n1Match) return {
    n1: n1Match.n1, n2: '', n3: '',
    n4: 'Gasto general', cantidad, monto,
    matchLevel:'n1', matchLabel: n1Match.n1, pendiente: false,
  }

  // ── 5. No encontrado → guardar como PENDIENTE DE REVISIÓN ─────────────
  return {
    n1: 'Sin definir', n2: '', n3: '',
    n4: q,
    cantidad, monto, unidad: 'unidad',
    matchLevel: 'libre',
    matchLabel: q,
    pendiente: true,
  }
